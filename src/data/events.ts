...
export const detailedEvents: DetailedEvent[] = [
...

  {
    ...
    image: "https://i.postimg.cc/0jDq3XGH/lbm-publikum-bei-bei-droemer-joachim-blobel-mdr-100-resimage-v-variant-Big16x9-w-832.avif",
    longDescription: `
14:43 Uhr –
Es war einer dieser Momente, in denen man sich fragt, ob das Schicksal einem wohlgesonnen ist. Ohne ein reserviertes Ticket für die Signierstunde von Sebastian Fitzek wagte ich mich dennoch in die Schlange. Die Uhr zeigte 14:43 Uhr, und ich war bereit, alles auf eine Karte zu setzen.
...
Dieser Tag war eine Achterbahn der Gefühle – von Frustration über Hoffnung bis hin zu triumphaler Erleichterung. Vielleicht war es Fitzeks Thriller-Atmosphäre, die sich auf das reale Leben übertragen hatte.`,
    ...
    media: [
      {
        type: "image",
        url: "https://i.postimg.cc/0jDq3XGH/lbm-publikum-bei-bei-droemer-joachim-blobel-mdr-100-resimage-v-variant-Big16x9-w-832.avif",
        title: "Bilder"
      }
    ],
    links: [
